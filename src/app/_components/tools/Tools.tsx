...
<div className="relative overflow-hidden px-0 md:px-20 lg:px-56">
  ...
  <div className="hidden lg:block pointer-events-none absolute top-0 left-[10%] h-full w-[444px] z-0 bg-gradient-to-r from-[#02050E] to-transparent" />
<div className="hidden lg:block pointer-events-none absolute top-0 right-[10%] h-full w-[444px] z-0 bg-gradient-to-l from-[#02050E] to-transparent" />
